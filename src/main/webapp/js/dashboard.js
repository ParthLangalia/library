...
document.addEventListener("DOMContentLoaded", function () {
  ...
  async function showBookDetails(bookId) {
    try {
      ...
      bookDetailContent.innerHTML = `
                <div class="book-detail-header">
                    ...
                    <div class="book-detail-info">
                        ...
                        <p class="book-detail-author">by ${escapeHtml(
                          book.author
                        )}</p>
                        <div class="book-detail-meta">
                            <span class="book-detail-category">
                                <i class="fas fa-bookmark"></i> ${formatCategory(
                                  book.category
                                )}
                            </span>
                ...
                <div class="book-detail-body">
                    ...
                    <div class="book-detail-actions">
                        ...
                        ${
                          isBorrowed
                            ? `<button class="btn btn-primary return-detail-btn" data-id="${
                                book.id
                              }">
                                <i class="fas fa-undo"></i> Return this Book
                             </button>
                             <div class="book-due-detail">Due: ${formatDate(
                               book.dueDate
                             )}</div>`
                            : ""
                        }
      ...
      const borrowDetailBtn =
        bookDetailContent.querySelector(".borrow-detail-btn");
      if (borrowDetailBtn) {
      ...
      const returnDetailBtn =
        bookDetailContent.querySelector(".return-detail-btn");
      if (returnDetailBtn) {
  ...
  async function borrowBook(bookId) {
    try {
      ...
      showMessage(
        "Book borrowed successfully! Due date: " + formatDate(result.dueDate),
        "success"
      );
